...
| コミット・課金（モック） | 案C（お金は預からない）。開始時にコミット額¥1,000〜10,000を宣言（課金なし）。達成した週は¥0で免除、未達週ぶんだけ後から課金。完全達成で課金ゼロ。すべてダミー |
...
| コミュニティ | 資格ごとの自動ランキングに加え、テーマ別コミュニティを検索・作成・参加できる（朝活部・社会人クラブ等・モック） |
